...
{
    pmic_config_interface(MT6350_PMIC_RG_USBDL_EN_ADDR, 0, MT6350_PMIC_RG_USBDL_EN_MASK, MT6350_PMIC_RG_USBDL_EN_SHIFT);
    pmic_config_interface(MT6350_PMIC_RG_FCHR_KEYDET_EN_ADDR, 0, MT6350_PMIC_RG_FCHR_KEYDET_EN_MASK, MT6350_PMIC_RG_FCHR_KEYDET_EN_SHIFT);
    pmic_config_interface(MT6350_PMIC_RG_FCHR_PU_EN_ADDR, 1, MT6350_PMIC_RG_FCHR_PU_EN_MASK, MT6350_PMIC_RG_FCHR_PU_EN_SHIFT);
    pmic_config_interface(MT6350_PMIC_RG_FCHRKEY_INT_SEL_ADDR, 1, MT6350_PMIC_RG_FCHRKEY_INT_SEL_MASK, MT6350_PMIC_RG_FCHRKEY_INT_SEL_SHIFT);
